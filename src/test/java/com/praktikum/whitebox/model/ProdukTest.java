...
//Anotasi untuk menyediakan data parameterized test dari sumber CSV
    ...
    // Tambahkan method berikut ke class ProdukTest yang sudah ada

    @Test
    @DisplayName("Test constructor default")
    void testDefaultConstructor() {
        Produk defaultProduk = new Produk();
        assertNull(defaultProduk.getKode());
        assertNull(defaultProduk.getNama());
        assertNull(defaultProduk.getKategori());
        assertEquals(0.0, defaultProduk.getHarga());
        assertEquals(0, defaultProduk.getStok());
        assertEquals(0, defaultProduk.getStokMinimum());
        assertFalse(defaultProduk.isAktif());
    }
    ...
    void testSettersAndGetters() {
        ...
        produk.setHarga(200000);
        produk.setStok(15);
        produk.setStokMinimum(3);
        ...
        assertEquals(200000, produk.getHarga());
        assertEquals(15, produk.getStok());
        assertEquals(3, produk.getStokMinimum());
    ...
    void testEqualsDifferentClass() {
        assertFalse(produk.equals("String object"));
    }
    ...
    void testToString() {
        ...
        assertTrue(toStringResult.contains("PROD001"));
        assertTrue(toStringResult.contains("Laptop Gaming"));
        assertTrue(toStringResult.contains("Elektronik"));
        assertFalse(toStringResult.contains("15000000"));
